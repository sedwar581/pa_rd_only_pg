    ...
    */
    ...
    for (var row_ct = 0; row_ct < num_tab_rows; row_ct++) {
        ...
        PA_sub_arr.forEach(function(elem, pa_ind) {
            ...
            var new_hdOUT_li = document.createElement('li');
            var new_SDOut_ul = document.createElement('ul');
            var new_SD_li = document.createElement('li');
            var new_sdOUT_li = document.createElement('li');
            ...
            new_HDTitle_span.setAttribute('class', "iocTitle");
            new_HDOut_span.setAttribute('class', "hdsd");
            new_SDTitle_span.setAttribute('class', "iocTitle");
            ...
            new_hdOutTitle_span.appendChild(document.createTextNode("OUT"));
            new_hdOUT_li.appendChild(new_hdOutTitle_span);
            new_HDOut_ul.appendChild(new_hdOUT_li);
            ...
            new_sdOutTitle_span.appendChild(document.createTextNode("OUT"));
            new_sdOUT_li.appendChild(new_sdOutTitle_span);
            new_SDOut_ul.appendChild(new_sdOUT_li);
