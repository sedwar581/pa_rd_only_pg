            ...
            new_pa_pg_req.addEventListener("load", function() {
                ...
                PA_list.forEach(function(pa_str) {
                    ...
                    if (papg_match != undefined) { // in case the PA in the PA_list is not on the PA page.
                        /* *********** *********** *********** *********** *********** *********** *********** 
                           If the browser is reporting an error at line 181 that the qfile_match.source is 
                           "null" - then 'reset/re-enter' the source in the PA on the router panel.  
                           Uncomment the line below to see which PA's source is "null" 
                        *********** *********** *********** *********** *********** *********** *********** */
